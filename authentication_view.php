...
<form method="post" action="index.php?action=connexion">
	<p class="champ">
    	...
    	<label for="mot_de_passe">Mot de passe</label><br/><input type="password" name="mot_de_passe" id="mot_de_passe" required>
	</p>
	<p>
...
<div id="container">       <!--on met tout les contenue dans le conteneur'container' -->
    <div id="list" style="left:-404px;">. <!-- le sous conteneur'list' met tout les images  -->
		<?php 
    ...
    <div id="buttons">  <!--le conteneur'buttons' met des petit point. -->
